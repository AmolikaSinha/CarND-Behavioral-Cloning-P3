...
with open('/root/Desktop/training_data/driving_log.csv') as csvfile:
  reader = csv.reader(csvfile)
  for line in reader:
    lines.append(line)

#with open('/root/Desktop/training_data1/driving_log.csv') as csvfile:
#  reader = csv.reader(csvfile)
#  for line in reader:
#    lines.append(line)
...
for line in lines:
  for i in range(3):
    ...
    current_path = '/root/Desktop/training_data/IMG/' + filename
